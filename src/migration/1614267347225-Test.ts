...
export class Test1614267347225 implements MigrationInterface {
    name = 'Test1614267347225'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tags" ("id" SERIAL NOT NULL, "epc" character varying NOT NULL, "hasErrors" boolean NOT NULL DEFAULT false, "status" character varying NOT NULL DEFAULT 'empty', "isAssigned" boolean NOT NULL DEFAULT false, "isProductTag" boolean NOT NULL DEFAULT false, "isPalletTag" boolean NOT NULL DEFAULT false, "isCarrierTag" boolean NOT NULL DEFAULT false, "palletId" integer, "carrierId" integer, CONSTRAINT "UQ_3db76f27b458b9e2a052d6d7c21" UNIQUE ("epc"), CONSTRAINT "REL_ce9ac338a11b9c6621b931f93a" UNIQUE ("palletId"), CONSTRAINT "REL_aed3170b1f298c5c7df2862882" UNIQUE ("carrierId"), CONSTRAINT "PK_e7dc17249a1148a1970748eda99" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "status" character varying, "expiry" character varying NOT NULL, "monthsLeftToExpire" character varying NOT NULL, "hasErrors" boolean NOT NULL, "isStoredOnPallet" boolean, "palletIsTrackedByRFID" boolean, "tagId" integer, "currentSectionId" integer, "storedInId" integer, CONSTRAINT "REL_07f1a140113cfa11902ad4c6d3" UNIQUE ("tagId"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "alerts" ("id" SERIAL NOT NULL, "reason" character varying NOT NULL DEFAULT 'Tag Count/Error', "type" character varying NOT NULL DEFAULT 'error', "severity" character varying NOT NULL DEFAULT 'error', "status" character varying NOT NULL DEFAULT 'sorted', "isResolved" boolean NOT NULL DEFAULT false, "productId" integer, "sectionsId" integer, "storeId" integer, "gateId" integer, "deviceId" integer, "historyId" integer, CONSTRAINT "PK_60f895662df096bfcdfab7f4b96" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_07f1a140113cfa11902ad4c6d35" FOREIGN KEY ("tagId") REFERENCES "tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
