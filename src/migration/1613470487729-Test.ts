...
export class Test1613470487729 implements MigrationInterface {
    name = 'Test1613470487729'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pallet" ("id" SERIAL NOT NULL, "count" integer NOT NULL, "type" character varying NOT NULL, "unitId" integer, "productId" integer, CONSTRAINT "PK_960fe7bd2b6dcb616fa59ac373b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_unit" ("id" SERIAL NOT NULL, "numberOfProducts" integer NOT NULL, "isTrackedByRFID" boolean NOT NULL, "useUnitAsDefault" boolean NOT NULL, "unitId" integer, "productId" integer, CONSTRAINT "PK_b15422982adca3bf53adfb535de" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "store" ("id" SERIAL NOT NULL, "number" character varying NOT NULL, "map" character varying, "storageType" character varying, "isActive" boolean, "hasErrors" boolean, "branchId" integer, CONSTRAINT "PK_f3172007d4de5ae8e7692759d79" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "status" character varying, "expiry" character varying NOT NULL, "monthsLeftToExpire" character varying NOT NULL, "hasErrors" boolean NOT NULL, "isStoredOnPallet" boolean, "palletIsTrackedByRFID" boolean, "tagId" integer, "presetId" integer, "currentSectionId" integer, "storedInId" integer, CONSTRAINT "REL_07f1a140113cfa11902ad4c6d3" UNIQUE ("tagId"), CONSTRAINT "REL_3b3d84f3b8890b8afa409ffe01" UNIQUE ("presetId"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
