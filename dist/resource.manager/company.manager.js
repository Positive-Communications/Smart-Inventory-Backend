...
var CompanyHandler = /** @class */ (function () {
    ...
    CompanyHandler.prototype.createCompany = function (req, res) {
    ...
    CompanyHandler.prototype.getCompanyByID = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var company;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ReadCompanyByID_1.default(req.params.id)];
                    case 1:
                        company = _a.sent();
                        res.json({ company: company });
                        return [2 /*return*/];
