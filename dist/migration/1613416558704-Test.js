...
exports.Test1613416558704 = void 0;
var Test1613416558704 = /** @class */ (function () {
    function Test1613416558704() {
        this.name = 'Test1613416558704';
    }
    Test1613416558704.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"company\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"city\" character varying, \"info\" character varying, \"headOffice\" character varying NOT NULL, \"email\" character varying NOT NULL, \"streetRoad\" character varying NOT NULL, \"primaryNumber\" character varying NOT NULL, \"secondaryNumber\" character varying NOT NULL, \"superAdminId\" integer, CONSTRAINT \"REL_cd4f3580a08a72ff162cbcad20\" UNIQUE (\"superAdminId\"), CONSTRAINT \"PK_056f7854a7afdba7cbd6d45fc20\" PRIMARY KEY (\"id\"))")];
                    case 8:
                        _a.sent();
                    ...
                    case 11:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"pallet\" (\"id\" SERIAL NOT NULL, \"count\" integer NOT NULL, \"type\" character varying NOT NULL, \"unitId\" integer, \"productId\" integer, CONSTRAINT \"PK_960fe7bd2b6dcb616fa59ac373b\" PRIMARY KEY (\"id\"))")];
                    case 12:
                        _a.sent();
                    ...
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"product_unit\" (\"id\" SERIAL NOT NULL, \"numberOfProducts\" integer NOT NULL, \"isTrackedByRFID\" boolean NOT NULL, \"useUnitAsDefault\" boolean NOT NULL, \"unitId\" integer, \"productId\" integer, CONSTRAINT \"PK_b15422982adca3bf53adfb535de\" PRIMARY KEY (\"id\"))")];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"store\" (\"id\" SERIAL NOT NULL, \"number\" character varying NOT NULL, \"map\" character varying, \"storageType\" character varying, \"isActive\" boolean, \"hasErrors\" boolean, \"branchId\" integer, CONSTRAINT \"PK_f3172007d4de5ae8e7692759d79\" PRIMARY KEY (\"id\"))")];
                    case 15:
                        _a.sent();
    ...
    Test1613416558704.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return Test1613416558704;
}());
exports.Test1613416558704 = Test1613416558704;
//# sourceMappingURL=1613416558704-Test.js.map