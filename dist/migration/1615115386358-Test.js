...
var Test1615115386358 = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"store\" (\"id\" SERIAL NOT NULL, \"number\" character varying NOT NULL, \"map\" character varying, \"storageType\" character varying, \"active\" boolean NOT NULL DEFAULT true, \"hasErrors\" boolean, \"branchId\" integer, CONSTRAINT \"PK_f3172007d4de5ae8e7692759d79\" PRIMARY KEY (\"id\"))")];
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"device\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"role\" character varying NOT NULL DEFAULT 'empty', \"allowPalletsToBeCountedManually\" boolean NOT NULL DEFAULT false, \"isActive\" boolean NOT NULL DEFAULT true, \"hasErrors\" boolean NOT NULL DEFAULT false, \"doNotAllowRemovalOfEmptyPallet\" boolean NOT NULL DEFAULT false, \"verifyStoredUsingHandHeld\" boolean NOT NULL DEFAULT false, \"showProductCountError\" boolean NOT NULL DEFAULT false, \"doNotAllowRemoval\" boolean NOT NULL DEFAULT false, \"verifyProductNotTrackedByRFID\" boolean NOT NULL DEFAULT false, \"automaticallyActivateRecallProductIfRequired\" boolean NOT NULL DEFAULT false, \"recordEmptyPallets\" boolean NOT NULL DEFAULT false, \"dispatchingOrReceiving\" boolean NOT NULL DEFAULT false, \"sectionsId\" integer, \"baysId\" integer, \"branchId\" integer, CONSTRAINT \"PK_2dc10972aa4e27c01378dad2c72\" PRIMARY KEY (\"id\"))")];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"bays\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"role\" character varying NOT NULL, \"hasErrors\" boolean, \"isActive\" boolean, \"storageType\" character varying NOT NULL, \"productId\" integer, \"storeId\" integer, CONSTRAINT \"PK_884565da9a418b01d1a2ef7306d\" PRIMARY KEY (\"id\"))")];
                    case 10:
                        _a.sent();
                    ...
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"scan_product_history\" (\"id\" SERIAL NOT NULL, \"timeStamp\" character varying NOT NULL, \"isReadByHandHeld\" boolean NOT NULL DEFAULT false, \"gateId\" integer, \"palletId\" integer, \"carrierId\" integer, \"tagId\" integer, CONSTRAINT \"PK_0e0fe776dbecb5dedb0664e62ba\" PRIMARY KEY (\"id\"))")];
                    case 15:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"move\" (\"id\" SERIAL NOT NULL, \"fromID\" character varying NOT NULL, \"toID\" character varying NOT NULL, \"timeStamp\" character varying NOT NULL, \"carrier\" character varying NOT NULL, \"arrived\" boolean NOT NULL DEFAULT false, \"fromSub\" character varying, \"product\" character varying NOT NULL, \"toSub\" character varying, \"isFull\" boolean NOT NULL DEFAULT false, \"isDefective\" boolean NOT NULL DEFAULT false, CONSTRAINT \"PK_0befa9c6b3a216e49c494b4acc5\" PRIMARY KEY (\"id\"))")];
                    case 16:
                        _a.sent();
                    ...
                    case 18:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"company\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"city\" character varying, \"registered\" character varying NOT NULL DEFAULT '1615115427514', \"info\" character varying, \"headOffice\" character varying, \"email\" character varying, \"streetRoad\" character varying, \"primaryNumber\" character varying, \"secondaryNumber\" character varying, \"superAdminId\" integer, CONSTRAINT \"UQ_a76c5cd486f7779bd9c319afd27\" UNIQUE (\"name\"), CONSTRAINT \"REL_cd4f3580a08a72ff162cbcad20\" UNIQUE (\"superAdminId\"), CONSTRAINT \"PK_056f7854a7afdba7cbd6d45fc20\" PRIMARY KEY (\"id\"))")];
                    case 19:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"tags\" (\"id\" SERIAL NOT NULL, \"epc\" character varying NOT NULL, \"hasErrors\" boolean NOT NULL DEFAULT false, \"status\" character varying NOT NULL DEFAULT 'empty', \"isAssigned\" boolean NOT NULL DEFAULT false, \"isProductTag\" boolean NOT NULL DEFAULT false, \"isPalletTag\" boolean NOT NULL DEFAULT false, \"isCarrierTag\" boolean NOT NULL DEFAULT false, \"productId\" integer, \"palletId\" integer, \"carrierId\" integer, \"companyId\" integer, CONSTRAINT \"UQ_3db76f27b458b9e2a052d6d7c21\" UNIQUE (\"epc\"), CONSTRAINT \"REL_ce9ac338a11b9c6621b931f93a\" UNIQUE (\"palletId\"), CONSTRAINT \"REL_aed3170b1f298c5c7df2862882\" UNIQUE (\"carrierId\"), CONSTRAINT \"PK_e7dc17249a1148a1970748eda99\" PRIMARY KEY (\"id\"))")];
                    case 20:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"pallet\" (\"id\" SERIAL NOT NULL, \"count\" integer NOT NULL, \"type\" character varying NOT NULL, \"status\" character varying NOT NULL DEFAULT 'empty', \"hasErrors\" boolean NOT NULL DEFAULT false, \"unitId\" integer, \"productId\" integer, CONSTRAINT \"PK_960fe7bd2b6dcb616fa59ac373b\" PRIMARY KEY (\"id\"))")];
                    case 21:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"unit\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, CONSTRAINT \"PK_4252c4be609041e559f0c80f58a\" PRIMARY KEY (\"id\"))")];
                    case 22:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"product_unit\" (\"id\" SERIAL NOT NULL, \"numberOfProducts\" integer NOT NULL, \"isTrackedByRFID\" boolean NOT NULL, \"useUnitAsDefault\" boolean NOT NULL, \"unitId\" integer, \"itemUnitId\" integer, \"productId\" integer, CONSTRAINT \"PK_b15422982adca3bf53adfb535de\" PRIMARY KEY (\"id\"))")];
                    case 23:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"product\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"description\" character varying NOT NULL, \"status\" character varying, \"expiry\" character varying NOT NULL, \"monthsLeftToExpire\" character varying NOT NULL, \"hasErrors\" boolean NOT NULL, \"isStoredOnPallet\" boolean, \"palletIsTrackedByRFID\" boolean NOT NULL DEFAULT false, \"currentSectionId\" integer, \"storedInId\" integer, CONSTRAINT \"PK_bebc9158e480b949565b4dc7a82\" PRIMARY KEY (\"id\"))")];
                    case 24:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"alerts\" (\"id\" SERIAL NOT NULL, \"reason\" character varying NOT NULL DEFAULT 'Tag Count/Error', \"type\" character varying NOT NULL DEFAULT 'error', \"severity\" character varying NOT NULL DEFAULT 'error', \"status\" character varying NOT NULL DEFAULT 'sorted', \"isResolved\" boolean NOT NULL DEFAULT false, \"productId\" integer, \"sectionsId\" integer, \"storeId\" integer, \"gateId\" integer, \"deviceId\" integer, \"historyId\" integer, \"tagId\" integer, CONSTRAINT \"PK_60f895662df096bfcdfab7f4b96\" PRIMARY KEY (\"id\"))")];
                    case 25:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"sections\" (\"id\" SERIAL NOT NULL, \"role\" character varying, \"name\" character varying NOT NULL, \"capacity\" integer NOT NULL DEFAULT '0', \"hasErrors\" boolean NOT NULL DEFAULT false, \"isActive\" boolean NOT NULL DEFAULT true, \"branchId\" integer, CONSTRAINT \"PK_f9749dd3bffd880a497d007e450\" PRIMARY KEY (\"id\"))")];
                    case 26:
                        _a.sent();
                    ...
                    case 32:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("CREATE TABLE \"transaction\" (\"id\" SERIAL NOT NULL, \"companyID\" integer NOT NULL, \"branchID\" integer, \"quantity\" integer NOT NULL, \"timeStamp\" character varying NOT NULL, \"type\" character varying NOT NULL, \"date\" character varying NOT NULL, CONSTRAINT \"PK_89eadb93a89810556e1cbcd6ab9\" PRIMARY KEY (\"id\"))")];
                    case 33:
                        _a.sent();
                    ...
                    case 39:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"orders\" ADD CONSTRAINT \"FK_388356a46d59f674c9564d60782\" FOREIGN KEY (\"orderBranchId\") REFERENCES \"branch\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 40:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"orders\" ADD CONSTRAINT \"FK_34303e2e7c06b3cc9760117eb5c\" FOREIGN KEY (\"collectionFromId\") REFERENCES \"branch\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 41:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"orders\" ADD CONSTRAINT \"FK_50951d523f19a113ed3d5916ba5\" FOREIGN KEY (\"issuedById\") REFERENCES \"branch\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 42:
                        _a.sent();
                    ...
                    case 44:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"order_details\" ADD CONSTRAINT \"FK_147bc15de4304f89a93c7eee969\" FOREIGN KEY (\"orderId\") REFERENCES \"orders\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 45:
                        _a.sent();
                    ...
                    case 57:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"bays\" ADD CONSTRAINT \"FK_76db522b3de363788ffdb619c06\" FOREIGN KEY (\"productId\") REFERENCES \"product\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 58:
                        _a.sent();
                    ...
                    case 61:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"preset_meta\" ADD CONSTRAINT \"FK_66baad1174e47c80fc6141122b1\" FOREIGN KEY (\"presetId\") REFERENCES \"presets\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 62:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"preset_meta\" ADD CONSTRAINT \"FK_fd124dff0372a1a4cdd67bd5751\" FOREIGN KEY (\"productId\") REFERENCES \"product\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 63:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" ADD CONSTRAINT \"FK_c511851466fe536e71e1852b490\" FOREIGN KEY (\"presetMetaId\") REFERENCES \"preset_meta\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 64:
                        _a.sent();
                    ...
                    case 66:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" ADD CONSTRAINT \"FK_9a259d52d4d11963ae4ec58bdd6\" FOREIGN KEY (\"dispatchedProductsId\") REFERENCES \"product\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 67:
                        _a.sent();
                    ...
                    case 68:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" ADD CONSTRAINT \"FK_70cef46ea5da47305a219cb2add\" FOREIGN KEY (\"storesId\") REFERENCES \"store\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 69:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" ADD CONSTRAINT \"FK_3d0766626cecc48986ea5576728\" FOREIGN KEY (\"gateId\") REFERENCES \"gate\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 70:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" ADD CONSTRAINT \"FK_00463cd708c0403d179ff6a82ee\" FOREIGN KEY (\"palletId\") REFERENCES \"pallet\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 71:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" ADD CONSTRAINT \"FK_a030c5ca41902eb707463b7cebb\" FOREIGN KEY (\"carrierId\") REFERENCES \"carrier\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 72:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" ADD CONSTRAINT \"FK_50a23f94b42d32a972f0c340a9a\" FOREIGN KEY (\"tagId\") REFERENCES \"tags\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 73:
                        _a.sent();
                    ...
                    case 77:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"company\" ADD CONSTRAINT \"FK_cd4f3580a08a72ff162cbcad208\" FOREIGN KEY (\"superAdminId\") REFERENCES \"users\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 78:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" ADD CONSTRAINT \"FK_1e685539b0827e801e5ac275db2\" FOREIGN KEY (\"productId\") REFERENCES \"product\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 79:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" ADD CONSTRAINT \"FK_ce9ac338a11b9c6621b931f93a3\" FOREIGN KEY (\"palletId\") REFERENCES \"pallet\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 80:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" ADD CONSTRAINT \"FK_aed3170b1f298c5c7df28628823\" FOREIGN KEY (\"carrierId\") REFERENCES \"carrier\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 81:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" ADD CONSTRAINT \"FK_40d3284c7c060f75caee62cf940\" FOREIGN KEY (\"companyId\") REFERENCES \"company\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 82:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"pallet\" ADD CONSTRAINT \"FK_e9f65f218a41b1734623f1f92ac\" FOREIGN KEY (\"unitId\") REFERENCES \"unit\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 83:
                        _a.sent();
                    ...
                    case 84:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"product_unit\" ADD CONSTRAINT \"FK_1b0079484a0d989857b7a0c737b\" FOREIGN KEY (\"unitId\") REFERENCES \"unit\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 85:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"product_unit\" ADD CONSTRAINT \"FK_7fd28d8769409b22b710d58f7c9\" FOREIGN KEY (\"itemUnitId\") REFERENCES \"unit\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 86:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"product_unit\" ADD CONSTRAINT \"FK_fdaa18f9ede4b96e4deaa98a4d3\" FOREIGN KEY (\"productId\") REFERENCES \"product\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 87:
                        _a.sent();
                    ...
                    case 89:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" ADD CONSTRAINT \"FK_2c64177b910f1688961c3bdfc4f\" FOREIGN KEY (\"productId\") REFERENCES \"product\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 90:
                        _a.sent();
                    ...
                    case 91:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" ADD CONSTRAINT \"FK_25ad228748a1854cfcf0ec644fd\" FOREIGN KEY (\"storeId\") REFERENCES \"store\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 92:
                        _a.sent();
                    ...
                    case 94:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" ADD CONSTRAINT \"FK_3873d79b8a1ff10ed0967736f87\" FOREIGN KEY (\"historyId\") REFERENCES \"scan_product_history\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 95:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" ADD CONSTRAINT \"FK_2a04e21b4f2c1f56425a1dbc24e\" FOREIGN KEY (\"tagId\") REFERENCES \"tags\"(\"id\") ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 96:
                        _a.sent();
    ...
    Test1615115386358.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" DROP CONSTRAINT \"FK_2a04e21b4f2c1f56425a1dbc24e\"")];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" DROP CONSTRAINT \"FK_3873d79b8a1ff10ed0967736f87\"")];
                    case 11:
                        _a.sent();
                    ...
                    case 13:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" DROP CONSTRAINT \"FK_25ad228748a1854cfcf0ec644fd\"")];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" DROP CONSTRAINT \"FK_883f029045a01666a83c9fed4a4\"")];
                    case 15:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"alerts\" DROP CONSTRAINT \"FK_2c64177b910f1688961c3bdfc4f\"")];
                    case 16:
                        _a.sent();
                    ...
                    case 18:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"product_unit\" DROP CONSTRAINT \"FK_fdaa18f9ede4b96e4deaa98a4d3\"")];
                    case 19:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"product_unit\" DROP CONSTRAINT \"FK_7fd28d8769409b22b710d58f7c9\"")];
                    case 20:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"product_unit\" DROP CONSTRAINT \"FK_1b0079484a0d989857b7a0c737b\"")];
                    case 21:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"pallet\" DROP CONSTRAINT \"FK_d3e8577c20f93ea348cce7b8c94\"")];
                    case 22:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"pallet\" DROP CONSTRAINT \"FK_e9f65f218a41b1734623f1f92ac\"")];
                    case 23:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" DROP CONSTRAINT \"FK_40d3284c7c060f75caee62cf940\"")];
                    case 24:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" DROP CONSTRAINT \"FK_aed3170b1f298c5c7df28628823\"")];
                    case 25:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" DROP CONSTRAINT \"FK_ce9ac338a11b9c6621b931f93a3\"")];
                    case 26:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"tags\" DROP CONSTRAINT \"FK_1e685539b0827e801e5ac275db2\"")];
                    case 27:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"company\" DROP CONSTRAINT \"FK_cd4f3580a08a72ff162cbcad208\"")];
                    case 28:
                        _a.sent();
                    ...
                    case 32:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" DROP CONSTRAINT \"FK_50a23f94b42d32a972f0c340a9a\"")];
                    case 33:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" DROP CONSTRAINT \"FK_a030c5ca41902eb707463b7cebb\"")];
                    case 34:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" DROP CONSTRAINT \"FK_00463cd708c0403d179ff6a82ee\"")];
                    case 35:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"scan_product_history\" DROP CONSTRAINT \"FK_3d0766626cecc48986ea5576728\"")];
                    case 36:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" DROP CONSTRAINT \"FK_70cef46ea5da47305a219cb2add\"")];
                    case 37:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" DROP CONSTRAINT \"FK_27aabffb6c4bc1e5a88c5e82137\"")];
                    case 38:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" DROP CONSTRAINT \"FK_9a259d52d4d11963ae4ec58bdd6\"")];
                    case 39:
                        _a.sent();
                    ...
                    case 41:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"gate\" DROP CONSTRAINT \"FK_c511851466fe536e71e1852b490\"")];
                    case 42:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"preset_meta\" DROP CONSTRAINT \"FK_fd124dff0372a1a4cdd67bd5751\"")];
                    case 43:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"preset_meta\" DROP CONSTRAINT \"FK_66baad1174e47c80fc6141122b1\"")];
                    case 44:
                        _a.sent();
                    ...
                    case 47:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"bays\" DROP CONSTRAINT \"FK_76db522b3de363788ffdb619c06\"")];
                    case 48:
                        _a.sent();
                    ...
                    case 63:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"orders\" DROP CONSTRAINT \"FK_50951d523f19a113ed3d5916ba5\"")];
                    case 64:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"orders\" DROP CONSTRAINT \"FK_34303e2e7c06b3cc9760117eb5c\"")];
                    case 65:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"orders\" DROP CONSTRAINT \"FK_388356a46d59f674c9564d60782\"")];
                    case 66:
                        _a.sent();
                    ...
                    case 72:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"transaction\"")];
                    case 73:
                        _a.sent();
                    ...
                    case 83:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"unit\"")];
                    case 84:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"pallet\"")];
                    case 85:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"tags\"")];
                    case 86:
                        _a.sent();
                    ...
                    case 89:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"move\"")];
                    case 90:
                        _a.sent();
                    ...
                    case 92:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("DROP TABLE \"preset_meta\"")];
                    case 93:
                        _a.sent();
    ...
    return Test1615115386358;
}());
exports.Test1615115386358 = Test1615115386358;
//# sourceMappingURL=1615115386358-Test.js.map