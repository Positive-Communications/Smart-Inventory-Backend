...
var Store = /** @class */ (function () {
    ...
    Store.prototype.createItself = function (name) {
    ...
    __decorate([
        typeorm_1.OneToMany(function (type) { return Alerts_1.default; }, function (alert) { return alert.store; }),
        typeorm_1.JoinTable(),
        __metadata("design:type", Array)
    ...
    __decorate([
        typeorm_1.OneToMany(function (type) { return Gate_1.default; }, function (gate) { return gate.stores; }),
        typeorm_1.JoinTable(),
        __metadata("design:type", Array)
    ], Store.prototype, "gates", void 0);
    Store = __decorate([
        typeorm_1.Entity()
    ], Store);
    return Store;
