...
var OrderDetails = /** @class */ (function () {
    ...
    OrderDetails.prototype.createItself = function (data) {
    ...
    OrderDetails.prototype.isLegit = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    __decorate([
        typeorm_1.ManyToOne(function (type) { return Product_1.default; }, function (product) { return product.orderDetails; }),
    ...
    ], OrderDetails.prototype, "unit", void 0);
    __decorate([
        typeorm_1.ManyToOne(function (type) { return Orders_1.default; }, function (orders) { return orders.orderDetails; }),
