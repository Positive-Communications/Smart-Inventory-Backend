...
var Device = /** @class */ (function () {
    function Device() {
        var _this = this;
        this.assignUUID = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    ], Device.prototype, "isHandHeld", void 0);
    __decorate([
        typeorm_1.Column({
            default: false
        }),
        __metadata("design:type", Boolean)
    ], Device.prototype, "isSensor", void 0);
    __decorate([
        typeorm_1.Column({
            default: false
        }),
        __metadata("design:type", Boolean)
    ], Device.prototype, "isTablet", void 0);
    __decorate([
        typeorm_1.Column({
            default: false
        }),
        __metadata("design:type", Boolean)
    ], Device.prototype, "isWeb", void 0);
    __decorate([
        typeorm_1.Column({
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], Device.prototype, "isFixed", void 0);
    __decorate([
        typeorm_1.Column({
            default: "empty"
        }),
