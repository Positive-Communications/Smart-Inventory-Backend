...
var AccessCard_1 = require("../../../entity/AccessCard");
var ReadBranchByID_1 = require("../../R/ByID/ReadBranchByID");
var typeorm_1 = require("typeorm");
function saveAccessCards(data) {
    return __awaiter(this, void 0, void 0, function () {
        var accessCard, _a, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    accessCard = new AccessCard_1.default();
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, typeorm_1.getConnection().manager.save(accessCard)];
...
exports.default = saveAccessCards;
var config = {
    tagType: "",
    userName: "",
    identificationType: "",
...
//# sourceMappingURL=SaveAccessCard.js.map