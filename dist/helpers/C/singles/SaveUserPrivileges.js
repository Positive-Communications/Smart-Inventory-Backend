...
var UserPrivileges_1 = require("../../../entity/UserPrivileges");
var typeorm_1 = require("typeorm");
function saveUserPrivileges(data) {
    return __awaiter(this, void 0, void 0, function () {
        var userPrivilege, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userPrivilege = new UserPrivileges_1.default();
                    return [4 /*yield*/, userPrivilege.createItself(data)];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
...
exports.default = saveUserPrivileges;
var config = {
    isAdmin: false,
...
//# sourceMappingURL=SaveUserPrivileges.js.map