...
var readTagByEPC = function (epc) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getConnection()
                    .createQueryBuilder()
                    .select('tag')
                    .from(Tags_1.default, 'tag')
...
exports.default = readTagByEPC;
//# sourceMappingURL=tagByEpc.js.map